...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of PSTCustomAlertController.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zzzworm@gmail.com/PSTCustomAlertController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zzzworm@gmail.com' => 'grant.zhou@ximalaya.com' }
  s.source           = { :git => 'https://github.com/zzzworm@gmail.com/PSTCustomAlertController.git', :tag => s.version.to_s }
