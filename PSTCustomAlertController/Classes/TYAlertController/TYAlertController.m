...
@property (nonatomic, strong) TYAlertView *alertView;
...
- (instancetype)initWithAlertView:(TYAlertView *)alertView preferredStyle:(TYAlertControllerStyle)preferredStyle transitionAnimation:(TYAlertTransitionAnimation)transitionAnimation transitionAnimationClass:(Class)transitionAnimationClass
{
    if (self = [self initWithNibName:nil bundle:nil]) {
        _alertView = alertView;
        _preferredStyle = preferredStyle;
        _alertView.preferredStyle = preferredStyle;
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (_viewWillAppearBlock) {
        _viewWillAppearBlock(_alertView);
    }
}
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if (_viewDidAppearBlock) {
        _viewDidAppearBlock(_alertView);
    }
}
...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    if (_viewWillDisappearBlock) {
        _viewWillDisappearBlock(_alertView);
    }
}
...
- (void)viewDidDisappear:(BOOL)animated
{
    ...
    if (_viewDidDisappearBlock) {
        _viewDidDisappearBlock(_alertView);
    }
}
...
{
    return self.alertView.textFieldArray;
}
